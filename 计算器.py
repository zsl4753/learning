...
def buju(root):
    global cuncu,vartex,result,fuhao
    ...
    button0 = tkinter.Button(root, text='0', width=5, command=anjianzhi('0').jia)
...
def caidan(root):
    ...
    submenu.add_separator()#加分割线
    submenu.add_command(label = '计算机')
